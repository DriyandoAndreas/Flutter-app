...
class PlaylistMengajarDayAfterTomorrow extends StatefulWidget {
  const PlaylistMengajarDayAfterTomorrow({super.key});

  @override
  State<PlaylistMengajarDayAfterTomorrow> createState() =>
      _PlaylistMengajarDayAfterTomorrowState();
}

class _PlaylistMengajarDayAfterTomorrowState
    extends State<PlaylistMengajarDayAfterTomorrow> {
  ...
  Widget build(BuildContext context) {
    ...
    final timeline =
        Provider.of<PlaylistMengajarProviderTomorrowAfter>(context);

    var id = user.currentuser.siskonpsn;
    var tokenss = user.currentuser.tokenss;

    if (id != null && tokenss != null) {
      timeline.getTommorroAfterTimeLine(id: id, tokenss: tokenss, interval: 2);
    }
    ...
    var tomorrowtimeline = timeline.tommorrowaftertimeline;

    var colortdayafteromorrow = Colors.red;

    var daysaftertomorrow = 'Lusa';

    return playListData(
      tomorrowtimeline,
      colortdayafteromorrow,
