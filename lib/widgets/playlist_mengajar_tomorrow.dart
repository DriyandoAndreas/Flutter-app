...
class PlaylistMengajarTomorrow extends StatefulWidget {
  const PlaylistMengajarTomorrow({super.key});

  @override
  State<PlaylistMengajarTomorrow> createState() =>
      _PlaylistMengajarTomorrowState();
}

class _PlaylistMengajarTomorrowState extends State<PlaylistMengajarTomorrow> {
  ...
  Widget build(BuildContext context) {
    ...
    final timeline = Provider.of<PlaylistMengajarProviderTomorrow>(context);

    var id = user.currentuser.siskonpsn;
    var tokenss = user.currentuser.tokenss;

    if (id != null && tokenss != null) {
      timeline.getTommorroTimeLine(id: id, tokenss: tokenss, interval: 1);
    }
    ...
    var tomorrowtimeline = timeline.tommorrowtimeline;

    var colortomorrow = Colors.amber;

    var daytomorrow = 'Besok';
